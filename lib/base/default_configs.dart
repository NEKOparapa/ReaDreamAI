...
const Map<String, dynamic> appDefaultConfigs = {
  ...
  'include_last_assistant_message_in_prompt': true,
  ...
  'game_stage_world_background':
      '在一个名为"艾瑞多"的奇幻世界，魔法与科技交织共存。古老的巨龙沉睡在浮空山脉之上，而地面的城市则充满了蒸汽驱动的机械和闪烁的霓虹灯。各个种族——精灵、矮人、人类和兽人——在脆弱的和平中维持着微妙的平衡。',

  'game_stage_story_direction':
      '故事将围绕"源石"的争夺展开。一个古老的预言暗示，当源石之心被触动时，沉睡的巨龙将会苏醒，为世界带来毁灭或新生。玩家的选择将决定世界的最终命运。',
  ...
  'game_stage_first_day_events': [
    {
      ...
      'scene_id':
          'pre_scene_1', // [更新] 尽量使用 ID 对应，如果 ID 对应不上 Workbench 会尝试用名字匹配
      'dialogues': [
  ...
  'comfyui_system_workflow_path':
      'assets/comfyui/WAI_NSFW-illustrious-SDXL工作流.json', // 系统预设工作流路径
  ...
  'comfyui_video_workflow_path':
      'assets/comfyui/video/video_wan2_2_14B_i2v.json', // 系统预设视频工作流路径
  ...
  'ai_novel_creation_introduction':
      '在魔法与科技交织的艾瑞多世界，年轻的精灵魔法师莉娜意外发现了一个古代遗物，从而卷入了一场关乎世界命运的巨大阴谋。',
  // 背景设定预设内容
  'ai_novel_creation_background_setting':
      '在一个名为“艾瑞多”的奇幻世界，魔法与科技交织共存。古老的巨龙沉睡在浮空山脉之上，而地面的城市则充满了蒸汽驱动的机械和闪烁的霓虹灯。各个种族——精灵、矮人、人类和兽人——在脆弱的和平中维持着微妙的平衡。',
  // 写作风格预设内容
  'ai_novel_creation_writing_style':
      '采用第三人称有限视角，文笔细腻，注重角色心理活动的描写和环境氛围的渲染。节奏快慢结合，在紧张的动作场面中穿插宁静的思考时刻，语言风格偏向史诗感与诗意。',
  // 主要角色预设内容
  ...
  'ai_novel_creation_storyline': [
    {
      ...
      "chapter_summary":
          "在蒸汽弥漫的城市“钢之心”的下层区，莉娜发现了一个无法用现有科技解释的古代遗物。这个发现让她原本平静的生活卷入了巨大的阴谋之中。",
      "time_span": "一个下午",
    ...
    },
    {
      ...
      "chapter_summary":
          "为了解读遗物，莉娜决定前往传说中的浮空山脉寻找答案。在旅途中，她遭遇了机械刺客的追杀，并得到了一位神秘矮人铁匠的帮助。",
      "time_span": "三天",
  ...
  'writing_background_cards': [
    {
      ...
      'name': '现代校园',
      'content':
          '故事发生在当代一所综合性大学。校园里有现代化的教学楼、图书馆、实验室和宿舍楼。学生们使用智能手机、笔记本电脑，在食堂、操场、社团活动室之间穿梭。有考试压力、恋爱烦恼、实习就业等现实问题，也有青春的活力与梦想。',
      'isSystemPreset': true,
    },
    {
      ...
      'name': '魔法世界',
      'content':
          '这是一个纯粹的魔法世界。魔法学院矗立在云端，学生们骑着飞天扫帚上课。魔杖、咒语、魔药是日常生活的一部分。有光明魔法与黑暗魔法的对抗，古老的预言和神秘的魔法生物。巫师、法师们研究着各种魔法体系，从元素魔法到时空魔法，从召唤术到变形术。',
      'isSystemPreset': true,
    },
    {
      ...
      'name': '赛博科技',
      'content':
          '2077年的超级都市，霓虹灯照亮永不停歇的夜晚。人体改造司空见惯，神经接口直连网络。巨型企业控制一切，街头帮派在阴影中生存。虚拟现实与现实边界模糊，AI与人类共存。飞行汽车穿梭在摩天大楼间，地下城充斥着改造人和黑客。',
      'isSystemPreset': true,
    },
  ],
  ...
  'writing_style_cards': [
    ...
    },
    {
      ...
      'name': '夸张狂放',
      'content':
          '极度夸张的感官描写，直白粗暴描写之中又带有夸张修辞，将细微的触感、声响、气味都放大到极致，每个场景都充满强烈的视觉冲击和感官直接的刺激，对各类器官的描写毫不避讳。',
      'isSystemPreset': true,
    },
    {
      ...
      'name': '日式轻小说',
      'content':
          '日式轻小说风格，大量使用内心独白和吐槽，人物对话充满个性。擅长用夸张的反应和表情描写来增强戏剧效果，节奏明快，画面感强，对各类器官的描写毫不避讳。',
      'isSystemPreset': true,
    },
  ],
  ...
  'drawing_style_tags': [
    {
      ...
      'name': '现实写真',
      'content':
          'realistic, photo-realistic, ultra-realistic, hyper-realistic, 8k',
    ...
    },
    {
      ...
      'name': '动漫风格',
      'content':
          'anime style, anime screencap, anime screenshot,anime coloring,',
    ...
    },
    {
      ...
      'name': '水彩风格',
      'content':
          'watercolor painting, soft edges, translucent layers, artistic brushstrokes',
  ...
  'drawing_negative_tags': [
    {
      ...
      'name': '通用负面',
      'content':
          'worst quality, bad quality, worst detail, bad anatomy, bad hands, extra digits, fewer, extra, missing, error, watermark, unfinished, displeasing, chromatic aberration, signature, artistic error, username, scan',
      'isSystemPreset': true,
    },
  ],
  ...
  'drawing_character_cards': [
    {
      ...
      'appearance':
          'long hair, straight hair, black hair, bangs, black eyes, fair skin, beautiful face',
      'clothing':
          'school uniform, sailor uniform, blue sailor collar, red necktie, white shirt, blue pleated skirt, black stockings, school shoes',
      'personality': '文静, 内向',
      'status': '',
      'other': '',
      'referenceImageUrl': null,
    ...
    },
    {
      ...
      'appearance':
          'blonde hair, golden hair, twintails, long twintails, big eyes, round eyes, blue eyes, sparkly eyes, blush, cute face, small stature, childlike',
      'clothing':
          'frilly dress, white dress, pink ribbons, bow, knee-high socks, mary janes, hair ribbons',
    ...
    },
    {
      ...
      'appearance':
          'medium hair, fluffy hair, silver hair, cat ears, cat tail, yellow eyes, slit pupils, cute face',
      'clothing':
          'maid outfit, frilly apron, maid headdress, puffy sleeves, black dress, white apron, bell collar, paw gloves',
  ...
  'prompt_cards': [
    {
      ...
      'name': '预设-角色向',
      "content":
          """你的任务是分析小说文本，识别具有强烈视觉表现力的关键场景，提取场景中的核心视觉要素（人物、动作、环境、情绪），生成结构化的英文绘图提示词。提示词生成规则与格式：
一、 提示词结构
...
""",
    ...
    },
    {
      ...
      'name': '预设-平衡向',
      'content':
          '''你的任务是仔细分析小说文本，捕捉关键的角色、动作、环境和氛围，选择情感冲击力最强的时刻，提取最具画面感的场景，并为每个场景生成详细的英文绘图提示词。对于部分场景（约20%的场景），生成纯背景插图，专注于环境和氛围，而不包含任何角色或主体。
英文绘画提示词应该遵守以下要求:
